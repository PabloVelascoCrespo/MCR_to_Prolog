...
def seleccionRelacion(id):
    relaciones = {
        'hyp':2, 'ant':4, 'der':2, 'vgp':4, 'per':4, 'sim':2, 'sub':2, 'xphyp':2, 'rel':2,
        'cat':2,'rgloss':2, 'rterm':2, 'uterm':2, 'mm':2, 'mp':2, 'sa':4, 'bis':2,
        'cau':2, 'fuz':2, 'ml':2, 'mmof':2, 'hp':2, 'm':2, 'in':2, 'ina':2,
        'ind':2, 'ini':2, 'inl':2, 'inp':2, 'isd':2, 'itd':2, 'xpfuz':2, 'xpant':2,
        'xpsim':2, 'near':2
        }

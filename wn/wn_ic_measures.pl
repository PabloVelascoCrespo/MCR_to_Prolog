%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% WN_CONNECT source v1.4 : wn_ic_measures module
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
/*
...
%% You must enter a specific word (either noun or verb). FAILURE if Word1 or Word2 is a variable.
nonvar(Word1),
nonvar(Word2),
%% Both Word1 and Word2 must be either nouns or verbs (but neither combinations of them nor adjectives)
lists:memberchk((SS_type1,SS_type2), [(n,n), (v,v)]),
(var(W1_Sense_num) ->
